...
type TodoClient interface {
	GetTodo(ctx context.Context, in *RequestTodo, opts ...grpc.CallOption) (*ReplyTodo, error)
}
...
func (c *todoClient) GetTodo(ctx context.Context, in *RequestTodo, opts ...grpc.CallOption) (*ReplyTodo, error) {
...
type TodoServer interface {
	GetTodo(context.Context, *RequestTodo) (*ReplyTodo, error)
...
func (UnimplementedTodoServer) GetTodo(context.Context, *RequestTodo) (*ReplyTodo, error) {
...
func _Todo_GetTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServer).GetTodo(ctx, req.(*RequestTodo))
	}
